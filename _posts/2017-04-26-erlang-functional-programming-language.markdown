...
```erlang
{'EXIT',FromPid,Reason} %% this is put into the mailbox, just like any regular message. [Links][link_vs_monitors_erlang] are bidirectional and [monitors][link_vs_monitors_erlang] are unidirectional.
```
